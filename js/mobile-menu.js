document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-b-navigation-list");
  const headerRef = document.querySelector(".q-b-header");
  const navigationRef = document.querySelector(".q-b-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-b-toggle-button img");
